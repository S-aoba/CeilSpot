...
export const MenuTabStyle = () => {
  ...
  const defaultTabStyle = 'flex items-center gap-2 text-xl px-2'
  const selectedStyle = 'flex items-center gap-2 text-xl px-2 text-sky-400 underline underline-offset-4'
