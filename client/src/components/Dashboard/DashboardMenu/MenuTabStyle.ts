...
export const MenuTabStyle = () => {
  ...
  const defaultTabStyle =
    'flex h-full w-40 items-center justify-center gap-2 px-3 py-2 text-gray-400 hover:bg-gray-200 rounded-xl hover:text-white'
  const selectedStyle =
    'flex h-full w-40 items-center justify-center gap-2 px-3 py-2 text-sky-400 rounded-xl bg-sky-400 text-white'
